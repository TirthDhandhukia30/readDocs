...
export const cloudEntries: SearchEntry[] = [
  ...
  { id: 'vercel-analytics-intro', title: 'Vercel Web Analytics', description: 'Web analytics and monitoring', url: 'https://vercel.com/docs/analytics', category: 'Cloud', source: 'Vercel', keywords: ['web analytics', 'analytics', 'monitoring', 'vercel analytics', 'performance'], priority: 80 },
  { id: 'vercel-analytics-getting-started', title: 'Getting started with Vercel Web Analytics', description: 'Get started with Vercel Web Analytics on your project', url: 'https://vercel.com/docs/analytics/getting-started', category: 'Cloud', source: 'Vercel', keywords: ['web analytics', 'getting started', 'setup', 'enable', 'analytics setup', 'vercel analytics', '@vercel/analytics'], priority: 85 },
  { id: 'vercel-analytics-package', title: 'Using the @vercel/analytics package', description: 'Learn how to use the @vercel/analytics package', url: 'https://vercel.com/docs/analytics/package', category: 'Cloud', source: 'Vercel', keywords: ['@vercel/analytics', 'analytics package', 'package', 'npm package', 'analytics'], priority: 80 },
  { id: 'vercel-analytics-custom-events', title: 'Vercel Web Analytics Custom Events', description: 'Track custom user interactions', url: 'https://vercel.com/docs/analytics/custom-events', category: 'Cloud', source: 'Vercel', keywords: ['custom events', 'events', 'tracking', 'button clicks', 'form submissions', 'vercel analytics'], priority: 75 },
  { id: 'vercel-analytics-filtering', title: 'Filtering Web Analytics Data', description: 'Filter and explore analytics data', url: 'https://vercel.com/docs/analytics/filtering', category: 'Cloud', source: 'Vercel', keywords: ['filtering', 'filter', 'data', 'analytics filtering', 'analytics data'], priority: 70 },
  { id: 'vercel-analytics-privacy', title: 'Web Analytics Privacy and Compliance', description: 'Privacy policy and compliance standards', url: 'https://vercel.com/docs/analytics/privacy-policy', category: 'Cloud', source: 'Vercel', keywords: ['privacy', 'compliance', 'gdpr', 'data privacy', 'compliance standards'], priority: 75 },
  { id: 'vercel-analytics-limits', title: 'Web Analytics Limits and Pricing', description: 'Limits, pricing and plan information', url: 'https://vercel.com/docs/analytics/limits-and-pricing', category: 'Cloud', source: 'Vercel', keywords: ['pricing', 'limits', 'plan', 'pro', 'enterprise', 'analytics pricing'], priority: 70 },
  { id: 'vercel-analytics-troubleshooting', title: 'Web Analytics Troubleshooting', description: 'Troubleshooting common issues', url: 'https://vercel.com/docs/analytics/troubleshooting', category: 'Cloud', source: 'Vercel', keywords: ['troubleshooting', 'issues', 'debug', 'not working', 'analytics troubleshooting'], priority: 65 },
